...
public class VerListaRepController {
	...
	//----------
	 ...
	 public void añadirCancion() {
		 ...
		 try {
				App.loadScene(new Stage(), "MostrarTodasCancionesElegir", "");
			} catch (IOException e) {
	 ...
	 public void eliminarCancion() {
		 ...
		 try {
			 if(tablaListaCanciones.getSelectionModel().getSelectedItem() != null) {
				 ...
				 ContieneDAO c = new ContieneDAO();
				 c.eliminar(listaSelecion.getId(), cancionSelect.getId());
